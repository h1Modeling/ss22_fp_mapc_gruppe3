...
public class ProcessComplexTaskDesire extends BeliefDesire {

    private TaskInfo info;

    public ProcessComplexTaskDesire(Belief belief, TaskInfo info, String supervisor) {
        super(belief);
        this.info = info;
        ...
        precondition.add(new AttachBlocksFromDispenserDesire(belief, info.requirements, supervisor));
    ...
    public int getPriority() {
        ...
        return 300 + (500 - Math.min(dispenserDist, abandonedDist));
    }
}
