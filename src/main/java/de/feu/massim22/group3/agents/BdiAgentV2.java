...
public class BdiAgentV2 extends BdiAgent<IDesire> implements Supervisable {
    ...
    public List<java.awt.Point> rgz = new ArrayList<>();
    
    /** A set of all reachable dispensers.*/
    public List<Thing> disp = new ArrayList<>();
    ...
    public Action step() {
        ...
        //AgentLogger.info(Thread.currentThread().getName() + " step() Waiting for decisionsDone - Step: " 
        //+ belief.getStep() + " , Agent: " + this.getName());
