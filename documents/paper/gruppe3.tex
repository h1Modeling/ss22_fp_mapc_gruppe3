...
Die enthaltenen Umgebungsdaten beschränken sich auf das aktuelle Sichtfeld des Agenten. Es ist weder die Größe des Simulationsgebiets, noch die absolute Position des Agenten bekannt. 
...
\end{enumerate}
Das Lösen des Teilproblems 1 befähigt den Agenten seine Ziel- und Absichtsfindung auf Grundlage von korrekten Entfernungsdaten, anstelle von approximative Annahmen z.B. über die Manhattan-Distanz $d(A, B) = | A_{x} - B_{x} | + | A_{y} - B_{y} |$, durchzuführen.
Wurde ein Ziel priorisiert, muss zu diesem ein ideal kurzer Weg gefunden werden.
...
\label{g3:pathfinding}
\end{wrapfigure}

- Karte ermöglicht Wegfindung
- Wie werden Ziele gewählt Grundproblem muss Distanzen kennen um Entscheidung zu treffen
- Agenten können Blöcke clearen interessanter aspect
- über Eck
Die 
